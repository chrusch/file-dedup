...
declare module 'workerpool' {
  ...
  export type Proxy<T extends {[k: string]: (...args: unknown[]) => unknown}> =
    {
  ...
  export interface WorkerPool {
     ...
     */
    exec<T extends (...args: unknown[]) => unknown>(
      method: T | string,
      params: Parameters<T> | null,
      options?: {on?: (payload: unknown) => void; transfer?: Transferable[]}
    ...
    proxy<T extends {[k: string]: (...args: unknown[]) => unknown}>(): Promise<
      Proxy<T>
    >;
     ...
     */
    terminate(force?: boolean, timeout?: number): Promise<unknown[]>;
  }
  ...
  export class Transfer {
     ...
     */
    constructor(message: unknown, transfer: Transferable[]);
  }
  ...
  export function worker(
    methods?: {[k: string]: (...args: [filePath: string]) => unknown},
